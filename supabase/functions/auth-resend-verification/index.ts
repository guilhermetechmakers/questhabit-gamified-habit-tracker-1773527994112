/**
 * QuestHabit — Resend verification email with cooldown (60s).
 * POST, requires Authorization. Returns cooldown_seconds when throttled.
 */
...
serve(async (req) => {
  ...
  try {
    ...
    return new Response(
      JSON.stringify({ success: true, cooldown_seconds: COOLDOWN_SECONDS }),
